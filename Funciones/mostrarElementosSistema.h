...
void mostrarProductos(List* lista); //Esta función recibe una lista de hasta 3 productos, y muestra su información asociada de forma secuencial en la pantalla (un producto al lado del otro).
